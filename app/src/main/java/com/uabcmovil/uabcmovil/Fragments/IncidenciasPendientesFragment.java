...
public class IncidenciasPendientesFragment extends Fragment {
    public IncidenciasPendientesFragment(){}
            ...
            public void update(Observable observable, Object o) {
                if(((String)o).equals("Se Modifico")){
                    if(Sesion.getInstance().getAlumno().getRol().equals("AdminLab"))
                        adapter.setData(connection.getAllIncidencias("Pendiente"));
                    if(Sesion.getInstance().getAlumno().getRol().equals("Profesor"))
                        adapter.setData(connection.getAllIncidencias("Pendiente",Sesion.getInstance().getAlumno().getNombre()));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.incidencias_pendientes_fragment_layout,container,false);
        imageView = view.findViewById(R.id.imageViewIncidenciasPendientes);
        rv = view.findViewById(R.id.rvIncidenciasPendientes);
        txt = view.findViewById(R.id.textViewIncidenciasPendientes);
