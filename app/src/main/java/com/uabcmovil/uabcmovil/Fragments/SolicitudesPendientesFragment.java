...
public class SolicitudesPendientesFragment extends Fragment {
            ...
            public void update(Observable observable, Object o) {
                if(((String)o).equals("Se Modifico")){
                    if(Sesion.getInstance().getAlumno().getRol().equals("AdminLab"))
                        adapter.setData(connection.getAllSolicitudes("Pendiente"));
                    if(Sesion.getInstance().getAlumno().getRol().equals("Profesor"))
                        adapter.setData(connection.getAllSolicitudes("Pendiente",Sesion.getInstance().getAlumno().getNombre()));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.solicitudes_pendientes_fragment_layout,container,false);
        imgNoSolicitudes = view.findViewById(R.id.imageViewSolicitudesPendientes);
        txtNoSolicitudes = view.findViewById(R.id.textViewSolicitudesPendientes);
        rvSolicitudes = view.findViewById(R.id.rvSolicitudesPendientes);
